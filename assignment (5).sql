...
(121, 1, 1, '男', '2026-03-14 15:29:53'),
(122, 1, 2, '中文(廣東話), 中文(普通話), 英文, 日文, 其他(其他: js, c++, py, html, css, php, tsx, ts, jsx)', '2026-03-14 15:29:53'),
(123, 1, 3, '即時通訊軟體（如 Line、WhatsApp、Discord）', '2026-03-14 15:29:53'),
(124, 1, 4, '18-24 歲', '2026-03-14 15:29:53'),
(125, 1, 5, 'efrsef', '2026-03-14 15:29:53'),
(126, 1, 6, '大專, 副學士, 高級文憑', '2026-03-14 15:29:53'),
(127, 1, 7, 'SFU', '2026-03-14 15:29:53'),
(128, 1, 8, 'HDAI-ICT', '2026-03-14 15:29:53'),
(129, 1, 9, '4', '2026-03-14 15:29:53'),
(130, 1, 10, '0001-01-01', '2026-03-14 15:29:53'),
(131, 1, 11, 'na', '2026-03-14 15:29:53'),
(132, 1, 12, 'na', '2026-03-14 15:29:53'),
(133, 1, 13, 'na', '2026-03-14 15:29:53'),
(134, 1, 14, '其他（請說明）(其他: na)', '2026-03-14 15:29:53'),
(135, 1, 15, 'na', '2026-03-14 15:29:53'),
(136, 1, 16, '4', '2026-03-14 15:29:53'),
(137, 1, 17, '2', '2026-03-14 15:29:53'),
(138, 1, 18, '2', '2026-03-14 15:29:53'),
(139, 1, 19, '4', '2026-03-14 15:29:53'),
(140, 1, 20, '4', '2026-03-14 15:29:53'),
(141, 1, 21, '其他運動（請說明）(其他: no moving)', '2026-03-14 15:29:53'),
(142, 1, 22, '搖滾 / 獨立音樂, 古典 / 器樂, 嘻哈 / Rap, 電子 / EDM, 爵士 / 藍調', '2026-03-14 15:29:53'),
(143, 1, 23, '科幻 / 奇幻', '2026-03-14 15:29:53'),
(144, 1, 24, '動作 / 冒險, 動畫 / 動漫 / 二次元, 科幻 / 奇幻', '2026-03-14 15:29:53'),
(145, 1, 25, '自然風景, 海灘度假, 美食之旅, 溫泉, 休閒, 其他旅遊類型（請說明）(其他: home)', '2026-03-14 15:29:53'),
(146, 1, 26, 'shit', '2026-03-14 15:29:53'),
(147, 1, 27, 'go eat urself', '2026-03-14 15:29:53'),
(148, 1, 28, '1', '2026-03-14 15:29:53'),
(149, 1, 29, 'aedwd', '2026-03-14 15:29:53'),
(150, 1, 30, 'adaw', '2026-03-14 15:29:53'),
(151, 1, 31, 'dwadwa', '2026-03-14 15:29:53'),
(152, 1, 32, 'wadw', '2026-03-14 15:29:53'),
(153, 1, 33, '234', '2026-03-14 15:29:53'),
(154, 1, 34, '23423', '2026-03-14 15:29:53'),
(155, 1, 35, '4234', '2026-03-14 15:29:53'),
(156, 1, 36, '234', '2026-03-14 15:29:53'),
(157, 1, 37, 'a@a', '2026-03-14 15:29:53'),
(158, 1, 38, '', '2026-03-14 15:29:53'),
(159, 1, 40, '其他時間（請說明）(其他: 23)', '2026-03-14 15:29:53'),
(160, 1, 41, 'fdds', '2026-03-14 15:29:53');
...
CREATE TABLE `questions` (
  ...
  `created_at` datetime DEFAULT current_timestamp(),
  `question_attr` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '{}'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `questions` (`question_id`, `page_id`, `type_id`, `question_text`, `question_order`, `is_required`, `placeholder`, `created_at`, `question_attr`) VALUES
...
(5, 1, 5, '請簡單描述您的背景', 5, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(6, 2, 3, '最高學歷？', 1, 1, '', '2026-03-09 20:26:45', '{}'),
(7, 2, 4, '就讀學校名稱', 2, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(8, 2, 4, '就讀科系', 3, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(9, 2, 6, '對學業滿意度', 4, 0, '', '2026-03-09 20:26:45', '{}'),
(10, 2, 7, '畢業年份', 5, 0, '如不願透露,請填寫01/01/0001', '2026-03-09 20:26:45', '{}'),
(11, 3, 4, '目前職稱', 1, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(12, 3, 4, '公司名稱', 2, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(13, 3, 4, '工作年資', 3, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(14, 3, 2, '擅長技能', 4, 0, '如不願透露,請選擇\"其他\"並填寫na', '2026-03-09 20:26:45', '{}'),
(15, 3, 5, '工作內容描述', 5, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
...
(21, 5, 2, '喜歡的運動', 1, 0, '如不願透露,請選擇\"其他\"並填寫na', '2026-03-09 20:26:45', '{}'),
(22, 5, 2, '喜歡的音樂類型', 2, 0, '如不願透露,請選擇\"其他\"並填寫na', '2026-03-09 20:26:45', '{}'),
(23, 5, 2, '喜歡的書籍類型', 3, 0, '如不願透露,請選擇\"其他\"並填寫na', '2026-03-09 20:26:45', '{}'),
(24, 5, 2, '喜歡的電影類型', 4, 0, '如不願透露,請選擇\"其他\"並填寫na', '2026-03-09 20:26:45', '{}'),
(25, 5, 2, '喜歡的旅遊類型', 5, 0, '如不願透露,請選擇\"其他\"並填寫na', '2026-03-09 20:26:45', '{}'),
(26, 6, 5, '對本問卷的建議', 1, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(27, 6, 4, '改進方向', 2, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(28, 6, 6, '滿意度評分', 3, 1, '', '2026-03-09 20:26:45', '{}'),
(29, 7, 4, '未來5年目標', 1, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(30, 7, 4, '職業規劃', 2, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(31, 7, 4, '學習計畫', 3, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(32, 7, 5, '對未來的看法', 4, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(33, 8, 4, '其他技能', 1, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(34, 8, 4, '特殊成就', 2, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(35, 8, 4, '參與活動', 3, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(36, 8, 5, '其他資訊', 4, 0, '如不願透露或無,請留空或填寫na', '2026-03-09 20:26:45', '{}'),
(37, 9, 9, '電子郵件', 1, 0, '如不願透露或無,請留空', '2026-03-09 20:26:45', '{}'),
(38, 9, 11, '電話號碼(包含區號)', 2, 0, '如不願透露或無,請留空', '2026-03-09 20:26:45', '{\"pattern\":\"\\\\+[\\\\d\\\\s\\\\-]{8,20}\"}'),
...
--
ALTER TABLE `answers`
  MODIFY `answer_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;
